...
export const REJECTED_ORDER_REQUEST = 'REJECTED_ORDER_REQUEST';
export const REJECTED_ORDER_SUCCESS = 'REJECTED_ORDER_SUCCESS';
export const REJECTED_ORDER_FAILURE = 'REJECTED_ORDER_FAILURE';
